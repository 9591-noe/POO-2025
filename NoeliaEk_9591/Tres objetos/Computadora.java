public class Computadora {
    ...
    public Computadora(String marca, String modelo, boolean estado, int ram, int almacenamiento, String color) {
        setMarca(marca);
        setModelo(modelo);
        setEstado(estado);
        setRam(ram);
    ...
    public Computadora(String marca, String modelo, boolean estado, int ram) {
        setMarca(marca);
        setModelo(modelo);
        setEstado(estado);
        setRam(ram); 
